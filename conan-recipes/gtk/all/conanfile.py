...
class GtkConan(ConanFile):
    ...
    def _configure_meson(self):
        ...
        defs["demos"] = "false"
        defs["datadir"] = os.path.join(self.package_folder, "share")
        defs["localedir"] = os.path.join(self.package_folder, "share", "locale")
        defs["sysconfdir"] = os.path.join(self.package_folder, "etc")
